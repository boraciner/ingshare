...
.login-wrap {
	...
	position: relative;
	background:
		url(https://www.ingbank.com.tr/F/Documents/Images/kurumsal_logo_genel_mudurluk/genel_mudurluk_gorsel.jpg)
		no-repeat center;
		...
		<div class="login-html">
			...
			<div class="login-form">
				...
				<div class="sign-up-htm">
					<form:form method="POST" action="${contextPath}/registration" modelAttribute="userForm">
						<div class="group">
